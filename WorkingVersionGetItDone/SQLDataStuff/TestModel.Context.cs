...
namespace WorkingVersionGetItDone.SQLDataStuff
{
    ...
    public partial class nflff_dbEntities : DbContext
    {
        ...
        public virtual ObjectResult<Member> GetMembersByGroup(string gname)
        {
            var gnameParameter = gname != null ?
                new ObjectParameter("gname", gname) :
                new ObjectParameter("gname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Member>("GetMembersByGroup", gnameParameter);
        }
    
        public virtual ObjectResult<Member> GetMembersByGroup(string gname, MergeOption mergeOption)
        {
            var gnameParameter = gname != null ?
                new ObjectParameter("gname", gname) :
                new ObjectParameter("gname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Member>("GetMembersByGroup", mergeOption, gnameParameter);
        }
    }
}
