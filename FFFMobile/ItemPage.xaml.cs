using FFFMobile.Common;
using FFFMobile.Data;
using System;
...
namespace FFFMobile
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        {
            HelpSettingsFlyout aboutSettingsFlyout = new HelpSettingsFlyout();
            aboutSettingsFlyout.DataContext = this.DefaultViewModel["Item"];
            aboutSettingsFlyout.ShowIndependent();
        }
